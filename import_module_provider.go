...
// reader for the module. This is needed if the client is calling the Parse() method of the pbparser library.
//
// If the client knows the import modules are on disk, they can instead call the ParseFile() method which
